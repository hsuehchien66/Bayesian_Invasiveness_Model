...
s_pneumoniae_gpsc_only_model_fit@model_name <- "s_pneumoniae_gpsc_only_model_fit"

## save model output
saveRDS(s_pneumoniae_gpsc_only_model_fit, "s_pneumoniae_gpsc_only_model_fit.rds")
