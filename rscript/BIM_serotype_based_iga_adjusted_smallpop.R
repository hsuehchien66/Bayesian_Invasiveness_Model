...
# feature1: serotype
# feature2: iga
s_pneumoniae_sero_iga_data <- process_input_data(BIM_sero_iga_input, main_feature = "feature1", 
...
serotype_based_iga_adjusted_model_fit<-rstan::sampling(two_feature_model_stan,
                                                        data = s_pneumoniae_sero_iga_data,
                                                        iter = num_iter,
                                                        cores = num_cores,
                                                        chains = num_chains)
serotype_based_iga_adjusted_model_fit@model_name <- "serotype_based_iga_adjusted_model"
saveRDS(serotype_based_iga_adjusted_model_fit, "serotype_based_iga_adjusted_model_fit.rds")
