...
# feature1: serotype
# feature2: iga
s_pneumoniae_iga_sero_data <- process_input_data(BIM_iga_sero_input, main_feature = "feature1", 
...
iga_based_serotype_adjusted_model_fit<-rstan::sampling(two_feature_model_stan,
                                                       data = s_pneumoniae_iga_sero_data,
                                                       iter = num_iter,
                                                       cores = num_cores,
                                                       chains = num_chains)
iga_based_serotype_adjusted_model_fit@model_name <- "iga_based_serotype_adjusted_model"
saveRDS(iga_based_serotype_adjusted_model_fit, "iga_based_serotype_adjusted_model_fit.rds")
